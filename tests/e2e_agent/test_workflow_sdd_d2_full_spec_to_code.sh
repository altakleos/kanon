...
PROMPT="Add a rate limiter module to this project. It should provide a RateLimiter class that limits function calls to N per second using a token bucket algorithm. This is a new user-visible capability."
