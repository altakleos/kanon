"""Tests for ci/check_template_consistency.py against the real repo."""
...
_VALIDATOR_PATH = _REPO_ROOT / "ci" / "check_template_consistency.py"
assert _VALIDATOR_PATH.is_file(), f"validator not found: {_VALIDATOR_PATH}"


def _load_validator():
    spec = importlib.util.spec_from_file_location("check_template_consistency", _VALIDATOR_PATH)
