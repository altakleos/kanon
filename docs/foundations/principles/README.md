...
Cross-cutting stances this project commits to. One principle per file. See `../../development-process.md` § Foundations for the `kind:` taxonomy (`pedagogical` / `technical` / `product`).
