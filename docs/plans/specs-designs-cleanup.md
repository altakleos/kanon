...
- [ ] AC-S1: `docs/specs/tiers.md` carries `status: superseded`, `superseded-by: 0048`. Body unchanged.
- [ ] AC-S2: `docs/specs/tier-migration.md` carries `status: superseded`, `superseded-by: 0048`. Body unchanged.
- [ ] AC-S3: `docs/specs/template-bundle.md` carries `status: superseded`, `superseded-by: 0048`. Body unchanged.
