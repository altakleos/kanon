...
- [x] AC-A1: `docs/decisions/0041-realization-shape-dialect-grammar.md` exists with `status: accepted` and the six required ADR sections.
- [x] AC-A2: ADR-0041 cites ADR-0048, ADR-0039, ADR-0040, ADR-0026.
- [x] AC-A3: At least five Alternatives Considered.

### Spec

- [x] AC-S1: `docs/specs/dialect-grammar.md` exists with `status: accepted`, `realizes:` and `stressed_by:` lists, and at least six dialect-grammar invariant anchors.
- [x] AC-S2: `fixtures_deferred: true` in frontmatter (Phase A authors fixtures).
- [x] AC-S3: `docs/specs/aspects.md` gains a cross-reference paragraph; existing INVs unchanged.

### Design

- [x] AC-D1: `docs/design/dialect-grammar.md` contains worked YAML examples of `realization-shape:` for at least two contract types.
- [x] AC-D2: Composition resolution algorithm specified in pseudocode.
- [x] AC-D3: `kanon contracts validate` walk specified in pseudocode.

### Indexes + CHANGELOG

- [x] AC-X1: `docs/decisions/README.md` updated.
- [x] AC-X2: `docs/design/README.md` updated.
- [x] AC-X3: `docs/specs/README.md` updated.
- [x] AC-X4: `CHANGELOG.md` `[Unreleased] §Added` gains a paragraph.

### Cross-cutting

- [x] AC-X5: `kanon verify .` → `status: ok`, zero warnings.
- [x] AC-X6: `python scripts/check_links.py` → ok.
- [x] AC-X7: `python scripts/check_foundations.py` → ok.
- [x] AC-X8: `python scripts/check_invariant_ids.py` → ok.
