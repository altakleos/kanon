...
- [x] AC-F1: `tests/test_cli_verify.py::test_verify_unknown_aspect` passes.
- [x] AC-F2: `tests/test_fidelity.py::test_run_project_validators_manifest_load_failure` passes.
- [x] AC-F3: `tests/test_verify_validators.py::test_kit_validator_lookup_failure_warns` passes.
- [x] AC-F4: `tests/test_verify_validators.py::test_fidelity_capability_lookup_failure_warns` passes.
- [x] AC-X1: Full pytest suite — 834 passed (was 830 + 4 fixed), 0 failed (was 4).
- [x] AC-X2: `kanon verify .` returns `status: ok`.
...
- [x] AC-X8: `CHANGELOG.md` `[Unreleased] § Fixed` gains a paragraph naming the regression.
- [x] AC-X9: Only `src/kanon/_verify.py`, `CHANGELOG.md`, and the plan file change.
