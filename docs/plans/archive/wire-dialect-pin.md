...
- [x] AC-M1: All 7 LOADER MANIFESTs declare `kanon-dialect: "2026-05-01"`
- [x] AC-M2: All 7 YAML manifests declare `kanon-dialect: "2026-05-01"`
- [x] AC-M3: `_load_aspects_from_entry_points()` invokes `validate_dialect_pin()` per entry
- [x] AC-M4: Equivalence test passes (LOADER MANIFEST union with top-entry+sub still equals)
