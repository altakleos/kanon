...
- [x] `kanon aspect set-depth <target> deps 2` scaffolds `scripts/check_deps.py`.
...
3. Create aspect directory tree: manifest.yaml, agents-md/depth-{0..2}.md, sections/dependency-hygiene.md, protocols/dependency-hygiene.md, files/scripts/check_deps.py.
