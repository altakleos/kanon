...
- [ ] Self-hosting: `.kanon/protocols/testing/` contains canonical protocol copies; testing enabled at depth 3 on this repo.
...
5. Copy protocols to `.kanon/protocols/testing/`.
