...
- [`src/kanon/_preflight.py:96`](../../packages/kanon-core/src/kanon_core/_preflight.py) — first lived call site.
- [`packages/kanon-aspects/src/kanon_aspects/aspects/kanon_security/protocols/secure-defaults.md`](../../packages/kanon-aspects/src/kanon_aspects/aspects/kanon_security/protocols/secure-defaults.md) — protocol carrying the carve-out.
