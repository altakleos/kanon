...
- [`src/kanon/kit/aspects/kanon-security/protocols/secure-defaults.md`](../../src/kanon/kit/aspects/kanon-security/protocols/secure-defaults.md) — protocol carrying the carve-out.
