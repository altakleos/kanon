...
- [`src/kanon_reference/data/kanon-security/protocols/secure-defaults.md`](../../src/kanon_reference/data/kanon-security/protocols/secure-defaults.md) — protocol carrying the carve-out.
