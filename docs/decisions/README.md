...
| [0051](0051-distribution-naming.md) | Distribution naming for the three-package split — `kanon-core`+`kanon-aspects`+`kanon-kit` (supersedes ADR-0048 names only) | draft | release |
