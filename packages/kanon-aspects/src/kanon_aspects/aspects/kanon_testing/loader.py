...
Mirrors packages/kanon-aspects/src/kanon_aspects/aspects/kanon_testing/manifest.yaml byte-for-byte in semantic content
...
MANIFEST: dict[str, Any] = {
    ...
    "depth-2": {
        ...
        "sections": [],
        "validators": ["kanon_core._validators.test_import_check"],
    },
    "depth-3": {
