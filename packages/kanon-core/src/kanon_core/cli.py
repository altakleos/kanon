...
from kanon_core._cli_aspect import _commit_aspect_meta, _set_aspect_depth
...
def init(
    ...
    from kanon_core._atomic import atomic_write_text, clear_sentinel, write_sentinel
...
def aspect_remove(target: Path, aspect_name: str) -> None:
    ...
    from kanon_core._manifest import _aspect_files, _aspect_protocols
...
def graph_rename(
    ...
    """
    from kanon_core._rename import perform_rename
...
def resolutions_check(target: Path) -> None:
    ...
    """
    from kanon_core._resolutions import stale_check
...
def contracts_validate(bundle_path: Path) -> None:
    ...
    from kanon_core._realization_shape import parse_realization_shape
